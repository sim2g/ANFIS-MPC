...
load result1.mat
%当前时刻输入状态量[Vy, Vx, rotation, angular velocity,steering]
x = [0.038745,14.85566,-1.61183,0.37818,0.35498];

[output1,fuzzifiedIn1,ruleOut1,aggregatedOut1,ruleFiring1] = evalfis(x,out_fis1);
[output2,fuzzifiedIn2,ruleOut2,aggregatedOut2,ruleFiring2] = evalfis(x,out_fis2);
[output3,fuzzifiedIn3,ruleOut3,aggregatedOut3,ruleFiring3] = evalfis(x,out_fis3);
[output4,fuzzifiedIn4,ruleOut4,aggregatedOut4,ruleFiring4] = evalfis(x,out_fis4);
